    ...
    <div id='body'>
        <div id="bigBox">
                ...
                <div class="inputBox">
                    ...
                    <div class="inputText">
                        <span class="iconfont icon-visible"></span>
                        <input type="password" placeholder="rePassword" v-model="form.userRepwd"/>
                    </div>
                </div>
                <input class="loginButton" type="button" value="submit" @click="register"/>
        </div>
    </div>
</template>
<script>
export default {
    ...
    methods: {
        register(){
				const self = this;
                if(this.form.userpwd===this.form.userRepwd){
